...
def test_update_note():
    ...
    expected_response_title: Dict[str, Any] = {"id": note_id, "message": "Note updated successfully"}
    expected_response_content: Dict[str, Any] = {"id": note_id, "message": "Note content updated successfully"}
